...
<template>
  <transition name="bottom-slide-transform" @after-enter="handleTransitionAfterEnter">
    <div
      ...
      class="music-detail fixed inset-x-0 m-auto"
    > 
      ...
      <div ref="scrollContainerRef" class="detail-content flex px-10 pt-5" @scroll="handleScroll">
        <rotate-cd />
        <div class="ml-10">
          <div style="width:550px">
            ...
            <p v-if="mainStore.currentPlaySong.alia" class="mt-2 text-center text-sm opacity-50">
          ...
          <div class="flex">
            <div>
              ...
              <div style="width:550px;height:300px;" class="mt-5">
                ...
                <div v-if="pageParams.pageCount > 1 && musicComment.comments" class="mt-6 flex justify-end">
                  <n-pagination
            ...
            <n-scrollbar style="max-height: 350px;padding-right:20px;" class="ml-20 pt-10">
              ...
              <n-spin :show="fetchSimiPlayListLoading" size="small">
                <div v-show="fetchSimiPlayListLoading" class="h-32 w-80" />
                <!-- 相似歌单推荐 -->
                <div
                  v-for="item in similarPlaylist"
                  v-show="!fetchSimiPlayListLoading"
                  :key="item.id"
                  class="flex cursor-pointer items-center p-2 hover:bg-neutral-50 dark:hover:bg-neutral-50/20"
                ...
                >
                  ...
                  />
                  <div class="ml-4">
                    <p class="w-60 truncate text-left text-sm">
                      {{ item.name }}
                    </p>
                    <p class="mt-2 w-60 truncate text-left text-sm">
              ...
              <n-spin :show="fetchSimilarSongIsLoading">
                <div v-show="fetchSimilarSongIsLoading" class="h-40 w-80" />
                <div
                  v-for="item in similarMusicList"
                  v-show="!fetchSimilarSongIsLoading"
                  :key="item.id"
                  class="flex cursor-pointer items-center p-1 hover:bg-neutral-50 dark:hover:bg-neutral-50/20"
                ...
                >
                  ...
                  <div class="ml-4">
                    ...
                    <p class="mt-2 w-60 truncate text-left text-sm opacity-50">
