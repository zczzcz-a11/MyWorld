...
<template>
  <div ref="scrollContainerRef" class="scrollContainer relative mt-10">
    <n-scrollbar
    ...
    >
      ...
      <div v-if="!mainStore.currentPlaySong?.isNotLyric" ref="lyricContainer">
        <div
          ...
          class="lyric-item text-center" :data-time="item.time"
        > 
    ...
    <div v-show="showSelectLyric" class="selectLyricContainer"> 
      <div class="flex items-center">
        ...
        <div class="line  ml-2 bg-gradient-to-r from-gray-300 dark:from-gray-500" />
      </div>
      <div class="flex items-center">
        <div class="line mr-2  bg-gradient-to-l from-gray-300 dark:from-gray-500" />
