...
onClickOutside(popoverContainerRef, (event:any) => {
...
<template>
  <n-layout-header bordered class="flex h-14 items-center justify-between px-4 sm:px-3">
    <div class="flex">
      <span class=" truncate">MyWorld✨</span>
      <layout-header-search />
    </div>
    <div class="flex items-center">
      <!-- 用户信息入口 -->
      <div v-if="mainStore.isLogin">
        <div v-if="mainStore.userProfile" class="mr-2 flex items-center">
          ...
          >
            <template #trigger>
              <p
                class="w-30 trigger cursor-pointer truncate pl-2 text-xs opacity-80 hover:opacity-100" 
            ...
            <div ref="popoverContainerRef" style="width:300px">
              ...
              <div class="mt-3 border-0 border-b border-solid border-gray-200  hover:bg-neutral-200/20 dark:border-gray-200/20">
                <!-- 个人信息设置 -->
                <div class="flex cursor-pointer items-center justify-between px-4 py-2" @click="handleInfoEditClick">
              ...
              <div class="border-0 border-b border-solid border-gray-200  hover:bg-neutral-200/20 dark:border-gray-200/20">
                <n-popconfirm
                  @positive-click="handlePositiveClick"
                >
                  <template #trigger>
                    <!-- 个人信息设置 -->
                    <div class="flex cursor-pointer items-center justify-between px-4 py-2">
                      <div class="flex items-center text-base">
