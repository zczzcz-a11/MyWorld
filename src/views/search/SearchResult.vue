  ...
  <div class="w-full">
    ...
    <div class="flex px-8">
      <div
        ...
        class="cursor-pointer  px-4 pb-2 opacity-80 transition-opacity hover:opacity-100"
      ...
      <div
        ...
        class="ml-4 cursor-pointer px-4 pb-2 transition-opacity hover:opacity-100" 
    ...
    <transition name="fade">
      <div v-show="currentTabIndex === 0" class="m-8 mt-4">
        ...
        />
        <!-- 分页 -->
        <div v-if="songListPageParams.pageCount > 1" class="my-6 flex justify-center">
          <n-pagination
    ...
    <transition name="fade">
      <div v-show="currentTabIndex === 1" style="margin-right:-5px">
        <n-spin :show="playListIsLoading" description="搜索中">
          ...
          <p v-if="playListSearchResult.playlistCount" class="mb-2 mt-4 pl-8 opacity-50">
          ...
          >
            ...
            <p class="flex w-80 items-center opacity-50">
              <n-icon :component="PlayCircleOutlined" />
              <span class="pl-2"> {{ formateNumber(item.playCount) }}</span>
            </p>
          </div>
          <!-- 分页 -->
          <div v-if="playListPageParams.pageCount > 1" class="my-6 flex justify-center">
            <n-pagination
