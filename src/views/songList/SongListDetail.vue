      ...
      <div v-if="songListDetail" class="flex justify-between">
        ...
        <div class="ml-8 flex-1">
          ...
          <div class="flex-items-center mt-3 text-sm">
            ...
            <span class="text-primary pl-4">{{ songListDetail.creator.nickname }}</span>
          ...
          <div class="mt-3">
            <div v-if="!songListDetail.isMyLike">
              ...
              <span class="text-primary cursor-pointer"> {{ songListDetail.tags.join(' / ') }} </span>
              <span
                v-if="isMySongList && !songListDetail.tags.length " 
                class="text-primary cursor-pointer" @click="() => selectSongListTagRef?.show()"
              > 添加标签</span>
            </div>
            <div class="flex">
              <div>
            ...
            <div v-if="isMySongList && !songListDetail.description && !songListDetail.isMyLike" class="flex">
              <span>简介</span>
              <span class="px-1">:</span>
              <span class="text-primary cursor-pointer" @click="toSongListEdit">添加简介</span>
            </div>
      ...
      <div :value="tabsValue" class="mt-10">
        ...
        <div v-show="tabsValue === 'comment'" class="mt-8">
          <div>
            ...
            <div v-if="pageParams.pageCount > 1" class="mt-6 flex justify-end">
              <n-pagination
